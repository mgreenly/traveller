# Adventure 001: The Inheritance - Timeline Appendix

## Estimated Timeline of Events

This timeline provides a realistic estimate of how many days pass from the start of the adventure to each major event. Times are cumulative from Day 0 (when PCs receive the summons).
...
- **Afternoon:** Meeting with Silas Kane at The Gilded Cage
- **Evening:** Loan finalized, travel preparations begin
...
- **Morning:** Arrive K'Kirka
- **Afternoon:** File salvage claim at designated court
- **Evening:** Adventure concludes

## Total Duration: Approximately 75 Days (2.5 months)

### Key Time Pressures:
1. **Loan Terms:** 
   - 60-day first payment (Tier 1 terms) - Only 15 days after claiming ship!
