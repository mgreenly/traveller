...
These locations and encounters are designed to be modular and reusable:
- Each establishment can be dropped into any appropriate starport or world
- NPCs can be renamed or adjusted to fit local conditions
- Task chains and difficulty numbers can be modified based on local law levels
- Establishments often appear as franchises, explaining their similar layouts across different worlds